...
public class JuegoPlataforma extends Canvas implements Runnable {
    ...
    public static String[] soundTracks={"bensound-epic.wav","bensound-inspire.wav","bensound-newdawn.wav",
        "bensound-thejazzpiano.wav","Scheming Weasel Faster.wav"};
    ...
    public static BufferedImage mesaReunion;
        ...
        if(etapa!=EtapaJuego.juego && etapa!=EtapaJuego.loading){
            ...
            switch (etapa){
                ...
                case ajustes:
                    ...
                    break;
                case créditos:
                    g2.drawImage(menúCréditos[langIndex],0, 0, getWidth(), getHeight(),null);
            }
            ...
            switch(langIndex){
                case 0:
                    s="Cargando nivel "+nivel+"...";
                    break;
                case 1:
                    s="Loading level "+nivel+"...";
                    break;
                default:
                    s="Le niveau "+nivel+" se charge...";
            }
            g2.drawString(s, 454, 290);
            musicMenú.stop();
            musicJuego.stop();
        }else if(etapa==EtapaJuego.juego){
    ...
    public void drawInfo(Graphics g){
        ...
        if(handler.nivel.llave.isRecogido())
    ...
    private void init() {
        ...
        fondoNubes= imageFrom("\\Spritesheets\\fondoNubes.png");
        ...
        mesaReunion = imageFrom("\\Spritesheets\\mesaReunion.png");
        ...
        nivelesMapeo = new BufferedImage[5];
        ...
        menúCréditos=new BufferedImage[3];
        initMenús("espanol", 0);
        initMenús("ingles", 1);
        initMenús("frances", 2);
    ...
    private void initMenús(String idioma, int i){
        ...
        menúCréditos[i]=imageFrom("\\Menús\\UI\\"+idioma+"\\menu_creditos.png");
    }
