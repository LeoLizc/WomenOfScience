    ...
    public void createLevel(BufferedImage level) {
        ...
        for (int y = 0; y < height; y+=paso) {
            for (int x = 0; x < width; x+=paso) {
                nivel.llave=new objeto.Llave(0, 0, JuegoPlataforma.llave.getWidth(),
                        JuegoPlataforma.llave.getHeight(), false, Id.llave, JuegoPlataforma.llave);
                nivel.addObjeto(nivel.llave);
                ...
                if (red == 0 && green == 0 && blue == 0){//Muro
                ...
                else if(red==0 && green==162 && blue==232){//El npc Aventurero explorador
                ...
                else if(red==255 && green==201 && blue==14){//El npc Aventurera explorador
                    Npc tnpc=new Npc(JuegoPlataforma.entityModels[1],64,64,false,Id.aventurera);
                    nivel.addNpc(tnpc);
                    ...
                    nivel.puerta=new Puerta(x/paso * 64, y/paso * 64, JuegoPlataforma.puertaRed.getWidth(),
                            JuegoPlataforma.puertaRed.getHeight(), true, Id.puerta, JuegoPlataforma.puertaRed,
                            JuegoPlataforma.puertaGreen, true);
                    nivel.addObjeto(nivel.puerta);
                }
                else if (red == 255 && green == 1 && blue == 0){//Puerta Abierta
                    nivel.puerta=new Puerta(x/paso * 64, y/paso * 64, JuegoPlataforma.puertaRed.getWidth(),
                            JuegoPlataforma.puertaRed.getHeight(), false, Id.puerta, JuegoPlataforma.puertaRed,
                            JuegoPlataforma.puertaGreen, false);
                    nivel.addObjeto(nivel.puerta);
                }
                ...
                else if (red == 255 && green == 174 && blue == 201){//fondoNubes
                    int w=JuegoPlataforma.nivelesMapeo[JuegoPlataforma.nivel-1].getWidth()/10*64-64,
                ...
                } else if (red == 107 && green == 105 && blue == 14) {//mesaReunion
                    nivel.addObjeto(new Construcción(x / paso * 64, y / paso * 64, JuegoPlataforma.mesaReunion.getWidth(),
                            JuegoPlataforma.mesaReunion.getHeight(), true, Id.mesaReunion, JuegoPlataforma.mesaReunion));
